...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
   ...
   <div class="sidebar-nav">
    ...
    <li ><a href="loadpatient.jsp" class="nav-header"><span class="fa fa-stethoscope"></span> Reports </a></li>
...
<div class="btn-toolbar list-toolbar divalign" >
    <button  class="btn btn-primary" ><i class="fa fa-plus"></i> Add New Staff</button>
...
{       staff2=rs.getInt(1);
        ...
        othernames=rs.getString("other_name");
        dept=rs.getString("Department");
         
         session.setAttribute("staffid",staff2);
         session.setAttribute("first_Name", firstname);
         session.setAttribute("last_name", lastname);
         session.setAttribute("other_name", othernames);
 ...
 %>
      ...
      <td><%= othernames %></td>
       ...
       <td><div align="center" data-toggle="modal" data-target="#editStaff"><a href="#editStaff"><i class="fa fa-folder-open"></i>Edit</div></a></td>
...
<div class="modal small fade" id="editStaff" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        <h4 class="alert" align="center">Staff Detail Form</h4>
        
        <div class="modal-body">
            <div id="myTabContent" class="tab-content">
        <div class="tab-pane active in" id="home">
            <form action="doprescription.jsp" method="post" name="prescription" >
                <h3>Staff ID: <b><%=staff2%></b></h3>
                <h3>Name: <b><%=fname%> <%= session.getAttribute("last_name")%></b></h3>
        ...
        <div class="form-group">
            <label>Mobile Phone: </label> <input type="number" name="phone" class="form-control">
        </div>
