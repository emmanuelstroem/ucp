<%-- 
    ...
    Created on : Jul 2, 2015, 12:44:01 PM
    Author     : Developer
--%>
...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <li ><a href="searchPatient.html" class="nav-header"><span class="fa fa-search"></span> Search Patient</a></li>
    <li ><a href="registerPatient.html" class="nav-header"><span class="fa fa-pencil"></span> Register Patient</a></li>
    <li ><a href="user.html" class="nav-header"><span class="fa fa-stethoscope"></span> Triage</a></li>
    <li ><a href="treatment.jsp" class="nav-header"><span class="fa fa-medkit"></span> Treatmement</a></li>
