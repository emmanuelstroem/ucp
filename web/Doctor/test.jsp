...
<div class="btn-toolbar list-toolbar divalign" >
    ...
    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#prescription">Prescribe</button>
    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#screening">screening</button>
...
<table class="table">
  ...
  <tbody>
        ...
        <% int icount=0;
               rs=stmt.executeQuery("select * from triage where patientID='"+2+"'");
while(rs.next())
{ %>   
              <td><%=PatientID%></td>
              ...
              <td><div><a href="view_patient.jsp?PatientID=<%=PatientID%>"><i class="fa fa-folder-open"></i>Load Details</a> </div></td>
